...
if ("geolocation" in navigator) {
    ...
    document.getElementById("longtude").innerHTML = longitude;
    document.getElementById("latitude").innerHTML = latitude;
    document.getElementById("current_location").innerHTML = `${longitude}/${latitude}`;
...
.then(function (response) {
    ...
    document.getElementById("direction").innerHTML = response.data.data.direction;
})
